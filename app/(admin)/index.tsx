...
const quickActions = [
  { title: 'Equipos', path: '/(admin)/equipos', icon: 'desktop-classic', bg: 'bg-blue-500' },
  { title: 'Usuarios', path: '/(admin)/usuarios', icon: 'account-multiple', bg: 'bg-purple-500' },
  { title: 'Asignación', path: '/(admin)/asignacion', icon: 'account-cog', bg: 'bg-emerald-500' },
  { title: 'Mantenimiento', path: '/(admin)/mantenimiento', icon: 'wrench', bg: 'bg-amber-500' },
  { title: 'Historial', path: '/(admin)/historial', icon: 'history', bg: 'bg-slate-900' },
